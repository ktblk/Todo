class TodoItemsController < ApplicationController
  ...
  #to reduce repition, it calls methods before anything else happens; shells below aren't empty, it just needs to exist; refactoring is thorough; set_todo_item is in a private block
